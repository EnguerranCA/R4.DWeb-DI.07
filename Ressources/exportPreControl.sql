...
--
-- Hôte : mysql
-- Généré le : jeu. 03 avr. 2025 à 20:24
...
CREATE TABLE `lego` (
  ...
  `lego_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(2, 'enguer@ran', '[]', '$2y$13$9APdXTeqypzXDrreR/RSieS3Dba.iN57fpyO6My7N4/jCupDz3vXO');
