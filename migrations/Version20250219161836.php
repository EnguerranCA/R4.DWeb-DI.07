 ...
 */
final class Version20250219161836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lego ADD category_id INT DEFAULT NULL, CHANGE description description VARCHAR(10000) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lego DROP category_id, CHANGE description description VARCHAR(10000) NOT NULL');
    }
}
